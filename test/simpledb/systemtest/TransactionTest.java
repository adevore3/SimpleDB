...
//                        System.out.println(Thread.currentThread().getName() + " -> Tuple to insert: " + t);
                        ...
                        q2.start();
                        q2.next();
//                        System.out.println(Thread.currentThread().getName() + " -> Delete Query 2: " + q2.next());
                        q2.close();
                        ...
                        q3.start();
                        q3.next();
//                        System.out.println(Thread.currentThread().getName() + " -> Insert Query 3: " + q3.next());
                        q3.close();
