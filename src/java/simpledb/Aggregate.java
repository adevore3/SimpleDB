...
public class Aggregate extends Operator {
    ...
    private void performAggregate() {
		...
		Type gfieldtype = (this._gfield == Aggregator.NO_GROUPING) ? null : td.getFieldType(this._gfield);
		Aggregator a;
		
		switch (td.getFieldType(this._afield)) {
			case INT_TYPE:
				a = new IntegerAggregator(this._gfield, gfieldtype, this._afield, this._aop);
				break;
			case STRING_TYPE:
				a = new StringAggregator(this._gfield, gfieldtype, this._afield, this._aop);
				break;
			default:
