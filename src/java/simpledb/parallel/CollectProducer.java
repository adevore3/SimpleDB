 ...
 * 
 * The producer actively pushes the tuples generated by the child operator to the paired
 * CollectConsumer.
 * 
 * */
public class CollectProducer extends Producer
{
    ...
    /**
     * The working thread, which executes the child operator and send the tuples to the paired
     * CollectConsumer operator
     * */
            ...
            try
            {
                ...
                if (buffer.size() > 0)
                    session.write(new TupleBag(CollectProducer.this.operatorID,
                            ...
                            {}), CollectProducer.this.getTupleDesc()));
                session.write(
                        new TupleBag(CollectProducer.this.operatorID,
                                CollectProducer.this.getThisWorker().workerID))
