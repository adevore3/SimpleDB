 ...
 * 
 * A Collect operator collects tuples from all the workers. There is a collect
 * producer on each worker, and a collect consumer on the server and a master
 * worker if a master worker is needed.
 * 
...
public class CollectConsumer extends Consumer {
	...
	/**
	 * innerBufferIndex and innerBuffer are used to buffer all the TupleBags
	 * this operator has received. We need this because we need to support
	 * rewind.
	 * */
	 ...
	 * */
	public CollectConsumer(CollectProducer child,
